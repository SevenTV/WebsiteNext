	...
	<div class="legal-page">
		...
		<ul>
			...
			<li>
				<p class="no-indent">
					...
					any electronic device, named SEVENTV SARL
				</p>
			</li>
			<li>
				<p class="no-indent">
					<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
					&quot;Us&quot; or &quot;our&quot; in this Agreement) refers to SEVENTV SARL.
				</p>
			</li>
			<li>
				<p class="no-indent"><strong>Country</strong> refers to: France</p>
			</li>
			<li>
				<p class="no-indent">
			...
			<li>
				<p class="no-indent"><strong>Service</strong> refers to the Application.</p>
			</li>
			<li>
				<p class="no-indent">
					...
					to the service or to assist the Company in analysing how the service is used.
				</p>
			</li>
			<li>
				<p class="no-indent">
		...
		<ul>
			...
			<li>
				<p class="no-indent">
					...
					contracted services, including security updates, when necessary or reasonable for their
					implementation.
				</p>
			</li>
			<li>
			...
			<li>
				<p class="no-indent">
					...
					merger, divestiture, restructuring, reorganisation, dissolution, or other sale or transfer of some
		...
		<ul>
			...
			<li>
				...
				will require those affiliates to honour this Privacy Policy. Affiliates include our parent company and
